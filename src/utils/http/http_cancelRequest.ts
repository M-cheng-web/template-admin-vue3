 ...
 * 阻止重复请求
 */
CancelRequest.prototype.stopRepeatRequest = function (config: any, axios: any) {
 ...
 */
CancelRequest.prototype.allowRequest = function (config: any) {
  if (!config) return
  const url = config?.baseURL + config?.url
